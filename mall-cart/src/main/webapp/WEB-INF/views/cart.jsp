...
<div class="w w1 header clearfix">
    <div id="logo"><a href="http://www.mall.com/"><img clstag="clickcart|keycount|xincart|logo"
                                                       src="${staticUrl }/images/logo.gif" title="返回淘淘商城首页"
                                                       alt="返回淘淘商城首页"></a></div>
        ...
        <div class="cart-inner">
            <div class="cart-thead clearfix">
                <div class="column t-checkbox form">
                    <input data-cart="toggle-cb" name="toggle-checkboxes" id="toggle-checkboxes_up" type="checkbox"
                           checked="" value="">
                    ...
                    <div id="product_11345721" data-bind="rowid:1" class="item item_selected ">
                        <div class="item_form clearfix">
                            ...
                            <div class="cell p-goods">
                                ...
                                <div class="p-name">
                                    <a href="http://www.mall.com/item/${cart.itemId }.html"
            ...
            <div class="ui-ceilinglamp-1" style="width: 988px; height: 49px;">
              ...
              <span class="column t-checkbox form">
                  ...
                  <a href="http://www.mall.com/" target="_blank" clstag="clickcart|keycount|xincart|coudanlink"
                     id="continue">继续购物</a>
              </span>
                    </div>
                  ...
                  <span class="check-comm-btns" id="checkout-jd">
                      <a class="checkout" href="http://www.mall.com/order/create.html"
