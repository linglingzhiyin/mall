...
<div id="o-header-2013">
    <div class="w" id="header-2013">
        <div id="logo-2013" class="ld">
            <a href="http://www.mall.com/" hidefocus="true" clstag="homepage|keycount|home2013|02a">
                <img src="${staticUrl }/images/logo.gif" width="270" height="60" alt="商城">
            </a>
        </div>
        <!--logo end-->
        <div id="search-2013">
        ...
        <div id="settleup-2013" clstag="homepage|keycount|home2013|05a">
            <dl>
                <dt class="ld">
                    <span class="shopping"><span id="shopping-amount"></span></span>
                    <a href="http://www.mall.com/cart.html" id="settleup-url">去购物车结算</a>
                </dt>
            </dl>
        </div>
        <!--settleup end-->
    ...
    <div class="w">
        <div id="nav-2013">
            <div id="categorys-2013" class="categorys-2014">
                <div class="mt ld">
                    <h2>
                        <a href="http://www.jd.com/allSort.aspx" clstag="homepage|keycount|home2013|06a">全部商品分类</a>
                    </h2>
                </div>
