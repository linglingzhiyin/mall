...
<div class="w">
    <div id="logo">
    	<a href="http://www.mall.com/" clstag="passport|keycount|login|01">
    		<img src="${staticUrl}/images/logo" alt="淘淘" width="170" height="60"/>
    	</a><b></b>
   	</div>
</div>
<form id="formlogin" method="post" onsubmit="return false;">
    ...
    <div class=" w1" id="entry">
        ...
        <div class="free-regist">
            <span><a href="http://sso.mall.com/user/register.html" clstag="passport|keycount|login|08">免费注册&gt;&gt;</a></span>
        </div>
    </div>
