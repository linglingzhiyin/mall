...
<%
    String staticUrl = "http://127.0.0.1:80";
...
<div class="w" id="logo">
    <div>
        <a href="http://www.mall.com/">
            <img src="${staticUrl}/images/logo.gif" alt="京东商城" width="170" height="60"/>
        </a> <b></b>
    </div>
</div>
...
<div class="w" id="regist">
    <div class="mt">
        ...
        <span style="text-align: right">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <a class="flk13" onclick="javascript:location.href=&quot;http://en.360buy.com&quot;+location.search;"
               href="#">English</a>
        </span>
            <span>我已经注册，现在就
            <a href="http://127.0.0.1:9003/user/login.html" class="flk13">登录</a>
        </span>
        </div>
    </div>
    <div class="mc">
