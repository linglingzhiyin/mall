...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
   ...
   <link rel="stylesheet" type="text/css" href="${staticUrl }/css/purchase.base.2012.css" />
   <link rel="stylesheet" type="text/css" href="${staticUrl }/css/purchase.sop.css" />
   ...
   <script type="text/javascript" src="${staticUrl }/js/jquery.cookie.js" charset="utf-8"></script>
...
<div class="w" id="headers">
		<div id="logo"><a href="http://www.mall.com/"><img alt="淘淘商城" src="${staticUrl }/images/logo.gif"></a></div>
