...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
	...
	<!--结算页面样式-->
    <link type="text/css" rel="stylesheet" href="${staticUrl }/css/base.css" />
    <link type="text/css" rel="stylesheet" href="${staticUrl }/css/purchase.checkout.css" />
	<script type="text/javascript" src="${staticUrl }/js/jquery-1.2.6.min.js"></script>
	<script type="text/javascript" src="${staticUrl }/js/jquery.checkout.js"></script>
	<script type="text/javascript" src="${staticUrl }/js/base-v1.js"></script>
	<script type="text/javascript" src="${staticUrl }/js/order.common.js"></script>
...
<!--shortcut end-->
	...
	<div class="w w1 header clearfix">
		<div id="logo"><a href="http://www.taotao.com/"><img src="${staticUrl }/images/logo.gif"  alt="淘淘商城" /></a></div>
...
<div class="bt bt-w freight-tooltip hide" id="transport">
   ...
   <div class="w">
	...
	<script type="text/javascript" src="${staticUrl }/js/order.js"></script>
	<script type="text/javascript" src="${staticUrl }/js/base-2011.js"></script>
    <script type="text/javascript" src="${staticUrl }/js/lib-v1.js"></script>
    <script type="text/javascript" src="${staticUrl }/js/jTips.js"></script>
